import 'package:error_base/src/error/exceptions.dart';
import 'package:error_base/src/error/failures.dart';
import 'package:error_base/src/error/result.dart';
import 'package:flutter/foundation.dart';

/// Executes [call] and wraps the outcome in a [Result].
///
/// This is the standard repository helper — it catches every known
/// [AppException] (thrown by the data layer / error interceptor) and maps
